...
object BinaryMLPTest extends App {
 ...
 val z = Array.tabulate(TEST_SIZE)(x => Array[Double](0.3 + 0.05*Random.nextDouble))
    ...
    // val x1 = Array.tabulate(100)(x => Array[Double](0.5 + 0.1*Random.nextDouble, 0.5 + 0.1*Random.nextDouble))
      
    //  val x2 =  Array.tabulate(100)(x => Array[Double](-0.5 + 0.1*Random.nextDouble, -0.5 + 0.1*Random.nextDouble))
      val x = x1 ++ x2
