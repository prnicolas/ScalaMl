...
import org.scalaml.reinforcement.qlearning.{QLearning, QLState, QLConfig}
...
object QLearningEval2 {
	...
	*/
    ...
    def run: Unit = {	
    	...
    	/*
	  	val qConfig = new QLConfig(alpha, gamma, episodeLength; numEpisodes, minQuality)
